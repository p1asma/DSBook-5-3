...
public: 
    ...
    void removeBiggerThan(const Type &x);
    void removeSmallerThan(const Type &x);
    void removeBetween(const Type &x,const Type &y);
...
private: 
    ...
    void removeBiggerThan(const Type &x,BinaryNode *&t);
    void removeSmallerThan(const Type &x,BinaryNode *&t);
    void removeBetween(const Type &x,const Type &y,BinaryNode *&t);
};
...
template <class Type> 
void BinarySearchTree<Type> ::removeBiggerThan(const Type &x){
    removeBiggerThan(x,root);
}

template<class Type> 
void BinarySearchTree<Type>:: removeBiggerThan(const Type &x,BinaryNode *&t){
    if (t==NULL) return;
    if (t->data>x) remove (t->data,t);
}

template<class Type>
void BinarySearchTree<Type>::removeSmallerThan(const Type &x){
    removeSmallerThan(x,root);
}
template <class Type> 
void BinarySearchTree<Type>:: removeSmallerThan (const Type &x,BinaryNode *&t){
    if (t==NULL) return ;
    if (t->data<x) remove(t->data,t);
}

template<class Type> 
void BinarySearchTree<Type>::removeBetween(const Type &x,const Type &y){
    removeBetween(x,y,root);
}

template<class Type> 
void BinarySearchTree<Type>::removeBetween(const Type &x,const Type &y,BinaryNode *&t){
    if (t==NULL ) return;
    if (t->data>x && t->data<y) remove(t->data,t);
...
int main(){
    ...
    tree.removeBetween(0,2);
    cout<<"1"<<(tree.find(3)?"exists":"doesnt exist");
    return 0;
}